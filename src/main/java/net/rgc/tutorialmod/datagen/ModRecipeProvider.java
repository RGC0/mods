...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(RecipeOutput pRecipeOutput) {
        ...
        List<ItemLike> ALEXANDRITE_SMEALTABLES = List.of(ModItems.RAW_ALEXANDRITE.get(),
        ...
        oreSmelting(pRecipeOutput, ALEXANDRITE_SMEALTABLES, RecipeCategory.MISC, ModItems.ALEXANDRITE.get(), 0.25f, 200, "alexandrite");
        oreBlasting(pRecipeOutput, ALEXANDRITE_SMEALTABLES, RecipeCategory.MISC, ModItems.ALEXANDRITE.get(), 0.25f, 100, "alexandrite");
